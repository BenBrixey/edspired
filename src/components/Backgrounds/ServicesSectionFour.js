...
const ServicesSectionFour = ({ className }) => {
      ...
      <GridWrapper>
        <ServiceWrapper>
          ...
          <ServiceImageWrapper>
            <ImageWrapper>
              <StaticImage
                src="../../images/exam-preperation-girl.jpg"
                alt="student sitting an exam"
              />
            </ImageWrapper>
            <LogoText>Exam Preperation</LogoText>
          </ServiceImageWrapper>
        </ServiceWrapper>
        <ServiceWrapper>
          <ServiceImageWrapper>
            <ImageWrapper>
              <StaticImage
                ...
                alt="student holding a help sign"
              />
            </ImageWrapper>
            <LogoText>Homework Help</LogoText>
          </ServiceImageWrapper>
          <ServiceTextWrapper>
            <SubjectTextWrapper>
              <LogoText>Maths</LogoText>
...
const StyledServicesSectionFour = styled(ServicesSectionFour)`
  margin-top: 2rem;
  width: 100%;
...
export default StyledServicesSectionFour;
